...
function auton() {
    ...
    move(1)
    collect(42, t_limit - climbTime)
    printT()
    shoot(1000, t_limit - climbTime)
    pts += 15

    console.log("AUTON POINTS:", pts)
    console.log("15 POINTS FROM CLIMBING")
    printT()
    printHopper()
    printSpace()
    t = t_limit
...
function transition() {
    ...
    console.log("TRANSITION POINTS:", pts - pt)
    printT()
    printHopper()
    printSpace()
    t = t_limit
...
function ourShift(t_limit) {
    ...
    console.log("OUR SHIFT POINTS:", pts - pt)
    printT()
    printHopper()
    printSpace()
}
...
function endgame(t_limit) {
    ...
    console.log("ENDGAME POINTS:", pts - pt)
    printT()
    printHopper()
    printSpace()
}
